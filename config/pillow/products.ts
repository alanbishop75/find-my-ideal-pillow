...
export const products: Product[] = [
  ...
  {
    id: "tempur-original-medium-uk",
    name: "Tempur Original Pillow (Small/Medium Frame)",
    brand: "TEMPUR",
    description:
    ...
    ukAmazonVerification: ukVerified(
      "B0BZW7L66T",
      "In Stock at £83.99. Product page: Tempur Original Pillow, ergonomic memory foam neck support, side/back sleepers, washable cover. Verified live 2026-06-18."
    ),
    attributes: {
      sleepPosition: "side",
      firmness: "firm",
  ...
  {
    id: "tempur-comfort-original-uk",
    name: "Tempur Comfort Pillow Original",
    brand: "TEMPUR",
    description:
    ...
    ukAmazonVerification: ukVerified(
      "B0CW3N4XVW",
      "In Stock at £99.75. Product page: Tempur Comfort Pillow Original, soft supportive memory foam profile, head/neck/shoulder support. Verified live 2026-06-18."
    ),
    attributes: {
      sleepPosition: "back",
      firmness: "medium-soft",
  ...
  {
    id: "tempur-original-large-uk",
    name: "Tempur Original Ergonomic Pillow (Large)",
    brand: "TEMPUR",
    description:
    ...
    ukAmazonVerification: ukVerified(
      "B00VX8QRAA",
      "In Stock at £93.99. Product page: TEMPUR Original ergonomic neck support pillow for medium/large frames and side/back sleepers. Verified live 2026-06-18."
    ),
    attributes: {
      sleepPosition: "side",
      firmness: "firm",
  ...
  {
    id: "tempur-original-xl-uk",
    name: "Tempur Original Ergonomic Pillow (Queen XL)",
    brand: "TEMPUR",
    description:
    ...
    ukAmazonVerification: ukVerified(
      "B00VX8UZZ8",
      "In Stock at £97.99. Product page: TEMPUR Original ergonomic pillow Queen XL, side/back sleepers, washable cover. Verified live 2026-06-18."
    ),
    attributes: {
      sleepPosition: "side",
      firmness: "firm",
  ...
  {
    id: "tempur-cloud-soft-uk",
    name: "Tempur Cloud Soft Pillow",
    brand: "TEMPUR",
    description:
    ...
    ukAmazonVerification: ukVerified(
      "B0CVQPYJRY",
      "In Stock at £109.99. Product page: TEMPUR Cloud Soft Pillow with adaptive micro-cushions and soft comfort profile. Verified live 2026-06-18."
    ),
    attributes: {
      sleepPosition: "back",
      firmness: "soft",
