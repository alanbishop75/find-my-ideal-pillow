...
export default function AboutPageClient() {
  ...
  const intro = region === "US"
    ? "FindMyIdealPillow is a free tool that helps you find the right pillow for how you sleep - no sign-up, no ads, and no pop-ups."
    : "FindMyIdealPillow is a free tool that matches you with the right pillow for how you sleep - no sign-up, no ads, and no pop-ups.";
  ...
  return (
    <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 20px", lineHeight: 1.8 }}>
      ...
      <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 16 }}>About FindMyIdealPillow</h1>
      ...
      <p>
        FindMyIdealPillow was built to cut through the noise of pillow marketing and give people a straightforward,
      ...
      <p>
        Have a suggestion or spotted an error? Email us at <a href="mailto:hello@findmyidealpillow.com">hello@findmyidealpillow.com</a>.
      </p>
    </div>
  );
}
