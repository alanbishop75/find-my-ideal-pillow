...
Live at: **[findyouridealpillow.com](https://www.findyouridealpillow.com)**
...
|---|---|---|
| `NEXT_PUBLIC_SITE_URL` | Yes | Full production URL, e.g. `https://www.findyouridealpillow.com` |
...
- [ ] `NEXT_PUBLIC_SITE_URL` set to `https://www.findyouridealpillow.com` in Vercel
...
- [x] Amazon UK affiliate tag (`findyouridealpillow-21`) is live (spot-checked May 2 2026)
...
Built on the FindYourIdeal platform. Each FindYourIdeal product is
