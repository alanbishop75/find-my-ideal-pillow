...
| 9 | **Verify canonical tags** after first deploy � confirm homepage canonical is `https://www.findyouridealpillow.com/` | Post-deploy check |
...
```
NEXT_PUBLIC_SITE_URL=https://www.findyouridealpillow.com
